...
Time Monitoring: Log and accumulate study hours dedicated to each subject.

Data Visualization: Automatically generate bar charts showing progress percentages, hours studied, and topic completion rates.

Exportable Reports: Generate full text-based summaries and download your study data as a CSV file for external use.
